<?php
	...
	$toko=$_POST['s_toko'];
	mysqli_query($koneksi,"update tb_bubble_drink set nama_bubble_drink='$nama_bubble_drink', harga_bubble_drink='$harga_bubble_drink', diskon_bubble_drink='$diskon_bubble_drink', id_toko='$toko' where id_bubble_drink='$id_bubble_drink'");
